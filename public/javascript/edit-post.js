//function to handle action when the 'edit post' button is clicked
async function editFormHandler(event) {
    event.preventDefault();
    console.log('save button clicked');
    //captures and assigns user input to variables
    ...
    //updates post with user-input via fetch request
...
//adds event listener to 'edit post' button
